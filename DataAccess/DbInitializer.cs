...
namespace DataAccess
{
    public class DbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            {
                UserName = "romanku@metropolia.fi",
                Email = "romanku@metropolia.fi",
                FirstName = "Roman",
                LastName = "Kuzero",
                PhoneNumber = "0468469217",
                StreetAddress = "Majurinkulma 2 B",
                State = "Uusimaa",
                PostalCode = "02600",
                City = "Espoo"
            }, "Admin123*").GetAwaiter().GetResult();

            ApplicationUser user = _db.ApplicationUsers.FirstOrDefault(u => u.Email == "romanku@metropolia.fi");
